...
## Стан кімнати
У v1.2.4 кімната зберігається в оперативній пам'яті одного server instance. Якщо Render перезапустить instance або ви зробите новий deploy під час гри, активна кімната буде втрачена. Не запускайте deploy під час ефіру.
